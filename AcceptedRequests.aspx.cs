...
{
    public partial class AcceptedRequests : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["id"] != null)
            {
                ...
                SqlCommand cmd = new SqlCommand("select i.*, r.* from tbl_register as r inner join tbl_interest as i on i.Sender_id=r.id where i.Reciver_id ='" + Session["id"] + "' and i.Status='" + 2 + "'", con);
