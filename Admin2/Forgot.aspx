<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Forgot.aspx.cs" Inherits="Matrimonial_final.Admin2.Forgot" %>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" runat="server" novalidate>
                                        ...
                                        <div class="col-12">
                                            <asp:Button ID="btnverify" class="btn btn-primary w-100" runat="server" Text="Login" OnClick="btnverify_Click" />
                                        </div>
