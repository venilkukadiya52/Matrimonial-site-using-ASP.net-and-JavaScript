<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Matrimonial_final.login" %>
                            ...
                            <div class="card-body">
                                ...
                                <form class="" method="POST" runat="server">
                                    ...
                                    <div class="mb-3 text-right">
                                        <a class="link-muted text-capitalize font-weight-normal" href="forgotpwd.aspx">Forgot Password?</a>
                                    </div>


                                    <div class="mb-5">
                                        <asp:Button ID="btnlogin" class="btn btn-block btn-primary" runat="server" Text="Login" OnClick="btnlogin_Click"/>
                                    </div>
                                </form>


                                <div class="separator mb-3">
                                    <span class="bg-white px-3 opacity-60">Don't have account?</span>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="Admin2/AdminLogin.aspx">Admin Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
