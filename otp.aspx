<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="otp.aspx.cs" Inherits="Matrimonial_final.otp" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-5 text-center">
                                    <h1 class="h3 text-primary mb-0">Verify OTP</h1>
                                    <p>Check your mail to get OTP</p>
                                </div>
                                <form runat="server" class="form-default" >
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <asp:TextBox ID="txtopt" class="form-control" runat="server" placeholder="Enter OTP Here..." required=""></asp:TextBox>
                                            </br>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-start">
                                    ...
                                    <div class="mb-5">
                                        <%--<button type="submit" class="btn btn-block btn-primary" id="btn_register"></button>--%>
                                        <asp:Button ID="btnverify" class="btn btn-block btn-primary" runat="server" Text="Verify Now!" OnClick="btnverify_Click"/>
                                    </div>
                                </form>
                            </div>
                        </div>
